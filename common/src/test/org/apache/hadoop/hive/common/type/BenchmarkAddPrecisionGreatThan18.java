        ...
        public void setup()
        {
            ...
            while (count < COUNT) {
                ...
                if (!divisor.isZero()) {
                    ...
                    bigDecimalDividends[count] = dividends[count].toBigDecimal();
                    bigDecimalDivisors[count] = divisors[count].toBigDecimal();

                    bigintDividends[count] = bigDecimalDividends[count].unscaledValue();
                    bigintDivisors[count] = bigDecimalDivisors[count].unscaledValue();
